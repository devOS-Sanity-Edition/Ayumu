...
for (var i = 0; i < array_length(objects); i++) {
	with (objects[i]) {
		...
		draw_rectangle_color(view_xport[view_current], view_yport[view_current], room_width, room_height, lightingColor, lightingColor, lightingColor, lightingColor, 0)
...
draw_surface(application_surface, room_width, room_height) // i think this causes funkiness?
surface_reset_target()
matrix_set(matrix_world, matrix_build(0, 0, 0, 0, 0, 0, 1, 1, 1))

gpu_set_blendmode_ext(bm_dest_color, bm_inv_dest_alpha)
draw_surface(shadowSurface, view_xport[view_current], view_yport[view_current])
